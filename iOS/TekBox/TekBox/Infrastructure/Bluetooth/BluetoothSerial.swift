...
final class BluetoothSerial: NSObject, CBCentralManagerDelegate, CBPeripheralDelegate, ObservableObject {
    ...
    var serviceUUID = CBUUID(string: "4fafc201-1fb5-459e-8fcc-c5c9c331914b")//CBUUID(string: "FFE0")
    
    /// UUID of the characteristic to look for.
    var characteristicUUID = CBUUID(string: "beb5483e-36e1-4688-b7f5-ea07361b26a8")//CBUUID(string: "FFE1")
    ...
    func startScan() {
        print("BluetoothSerial() starting scan")
        guard centralManager.state == .poweredOn else {
            print("not powered on. abandoning scan.")
            return }
        ...
        for peripheral in peripherals {
            print("adding peripheral in BluetoothSerial")
    ...
    func centralManager(_ central: CBCentralManager, didDisconnectPeripheral peripheral: CBPeripheral, error: Error?) {
        ...
        // send it to the delegate
        delegate.serialDidDisconnect(peripheral, error: error as NSError?, self.isPoweredOn)
    }
