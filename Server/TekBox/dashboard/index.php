...
<html> 
	...
	<body> 
							...
							<div id="dashboardcage">
								<div id="dashboardframe">
									<a href="./" id="headdashboardlink">
										...
										<span id="orangeDashboardCurrent">Dashboard</span>
									</a>
								</div>
							</div>
		...
		if ($mysqli->connect_errno) {
			...
			if ($adminResult = mysqli_query($mysqli, $adminQuery)) {
				$adminCount = mysqli_num_rows($adminResult);
				
				if ($adminCount > 0) {
					$adminRow = mysqli_fetch_row($adminResult);
					
					$adminName = $adminRow[0];
					echo "<h3>Hello, $adminName!</h3>";
				} else {
